...
const Product = () => {
  ...
  const handleViewProduct = async () => {
    try {
      ...
      const res = await axios.get(`https://node-mongodb-api-4zq2.onrender.com/api/admin/product`);
  ...
  const handleDeleteProduct = async (productId) => {
    try {
      const response = await axios.delete(
        `https://node-mongodb-api-4zq2.onrender.com/api/admin/product/${productId}`
      );
